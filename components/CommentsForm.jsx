...
const CommentsForm = ({ slug }) => {
  ...
  return (
    <div className="bg-gradient-to-tl from-black to-gray-900 border border-gray-700 shadow-lg rounded-lg p-8 pb-12 mb-8">
      ...
      <div className="mt-8">
        <button type="button" onClick={handlePostSubmission} className="transition duration-500 ease hover:bg-indigo-900 inline-block bg-indigo-600 text-lg font-medium rounded-full text-white px-8 py-3 cursor-pointer">Post Comment</button>
