...
const PostDetail = ({ post }) => (
  <div className="mb-8 rounded-lg bg-white pb-12 lg:p-8">
      <h1 className="mt-2 mb-2 ml-2 text-3xl font-semibold">{post.title}</h1>
      <div className="mb-8 flex w-full items-center">
        <div className="mr-8 items-center justify-center md:flex lg:mb-0 lg:w-auto">
          <p className="ml-2  align-middle text-sm text-gray-700">
            {post.author.name}
          </p>
        </div>
        <div className="font-medium text-gray-700">
          <svg
            ...
            className="mr-2 inline h-4 w-4 text-black"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
      ...
      <div className="relative mb-6 overflow-hidden shadow-md">
          <img
            ...
            className="h-full w-full rounded-lg object-cover  object-top shadow-2xl lg:rounded-lg"
          />
      </div>
    <div className="px-4 lg:px-0">
      ...
      <RichText className="rounded-lg" content={post.content.raw} 
                renderers={{
                      ...
                      h2: ({ children }) => <h2 className="text-black text-2xl mt-4 mb-2">{children}</h2>,
